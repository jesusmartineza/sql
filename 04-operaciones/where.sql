...
SELECT actor_id, first_name, last_name FROM actor WHERE actor_id < 20;

/* Selecconar elementos con id pares */
...
SELECT * FROM actor WHERE first_name LIKE '%an%' OR last_name LIKE 'j%';